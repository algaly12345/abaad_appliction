                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Container(
                          ...
                          child: DropdownButton<int>(
                            ...
                            items: zoneController.categoryIds.map((int value) {
                              return DropdownMenuItem<int>(
                                value: zoneController.categoryIds.indexOf(value),
                                child: Text(value != 0 ? zoneController.categoryList[(zoneController.categoryIds.indexOf(value)-1)].nameAr : 'Select'),
                              );
                            }).toList(),
                            onChanged: (int value) {
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Container(
                          ...
                          child: DropdownButton<int>(
                            ...
                            items: zoneController.subCategoryIds.map((int value) {
                              return DropdownMenuItem<int>(
                                value: zoneController.subCategoryIds.indexOf(value),
                                child: Text(value != 0 ? zoneController.subCategoryList[(zoneController.subCategoryIds.indexOf(value)-1)].nameAr : 'Select'),
                              );
                            }).toList(),
                            onChanged: (int value) {
